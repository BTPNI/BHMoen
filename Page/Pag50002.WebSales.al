...
page 50002 "APIV2 - Sales Orders moen"
{
    APIVersion = 'v2.0';
    EntityCaption = 'Sales Order Moen';
    EntitySetCaption = 'Sales Order Moen';
    ChangeTrackingAllowed = true;
    DelayedInsert = true;
    EntityName = 'salesOrderMoen';
    EntitySetName = 'salesOrderMoen';
    ODataKeyFields = Id;
    APIPublisher = 'Moen';
    APIGroup = 'Moen';
    PageType = API;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                part(salesOrderLines; Microsoft.API.V2."APIV2 - Sales Order Lines")
                {
                    Caption = 'Lines';
                ...
                field(Weborder; Rec.Weborder)
                {
                    ...
                    trigger OnValidate()
                    begin
                        RegisterFieldSet(Rec.FieldNo(Weborder));
                    end;
                }
                field(WeborderID; Rec.WeborderID)
                {
                    ...
                    trigger OnValidate()
                    begin
                        RegisterFieldSet(Rec.FieldNo(WeborderID));
                    end;
                }
                field(WebReference; Rec.WebReference)
                {
                    ...
                    begin
                        ...
                        RegisterFieldSet(Rec.FieldNo(WebReference));
                ...
                part(documentAttachments; Microsoft.API.V2."APIV2 - Document Attachments")
                {
    ...
    var
        ...
        APIV2SendSalesDocument: Codeunit Microsoft.API.V2."APIV2 - Send Sales Document";
    ...
    begin
        ...
        if Invoiced then
            SetActionResponse(ActionContext, SalesInvoiceAggregator.GetSalesInvoiceHeaderId(SalesInvoiceHeader), Page::Microsoft.API.V2."APIV2 - Sales Invoices", WebServiceActionResultCode::Deleted)
        else
            SetActionResponse(ActionContext, SalesHeader.SystemId, Page::Microsoft.API.V2."APIV2 - Sales Orders", WebServiceActionResultCode::Updated);
    end;
}
